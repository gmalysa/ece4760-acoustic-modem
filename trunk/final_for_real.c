...
int main() {
	...
	while(1) {
		...
		//if(input_ready) {
			if(fix2int(input_buffer_resample_position + f4000_quarterphase) < public_input_buffer_position){// || fix2int(input_buffer_resample_position + float2fix(10./4.)) - public_input_buffer_position > IN_BUFFER_SIZE / 2) {
